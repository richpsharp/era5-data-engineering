...
# Conditional logic to set the parameters based on the workspace URL
if workspace_url == dev_workspace_url:
    # If in the dev workspace, these are the parameter values
    catalog_name = 'pilot'
    bronze_schema_name = "bronze_test"
    silver_schema_name = "bronze_test" 
    ...
    final_countries_table = f"{catalog_name}.{silver_schema_name}.esri_worldcountryboundaries_global_silver_test"

    print("Line executed in the dev workspace.")
else:
    # Do not run the Line if not in the dev workspace
    print("Line not executed in this workspace.")
