...
if workspace_url == dev_workspace_url:
  ...
  tessellated_table = f"{catalog_name}.{bronze_schema_name}.countries_h3_res4"
  chip_table = f"{catalog_name}.{silver_schema_name}.esri_worldcountryboundaries_global_silver_chips_res4"
  final_countries_table = f"{catalog_name}.{silver_schema_name}.esri_worldcountryboundaries_global_silver_res4"
  ...
  print("This code is not configured to run outside of dev and staging workspaces")
