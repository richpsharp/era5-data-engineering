...
if workspace_url == dev_workspace_url:
    ...
    schema = 'silver_dev'
    table = 'aer_era5_silver_approximate_1950_to_present_dev_interpolation_res4'
    ...
    df_grid_index_lat_lon_duplicates.write.format("delta").mode("overwrite") \
        .saveAsTable(f"{catalog}.{schema}.approximate_join_time_lat_lon_grid_index_duplicates_with_details_res4")
    ...
    for var in variables:
        ...
        df_variable_duplicates.write.format("delta").mode("overwrite") \
            .saveAsTable(f"{catalog}.{schema}.approximate_join_duplicates_{var}_res4") 
    ...
    table = 'aer_era5_silver_approximate_1950_to_present_staging_interpolation_res4'
