...
if workspace_url == dev_workspace_url:
    ...
    target_silver_table = "`era5-daily-data`.silver_dev.aer_era5_silver_strict_1950_to_present_dev_interpolation_res4"
    country_index_table = "`era5-daily-data`.silver_dev.esri_worldcountryboundaries_global_silver_res4"
    checkpoint = "/Volumes/era5-daily-data/silver_dev/checkpoints/era5_silver_country_strict_dev_res4"
    ...
    target_silver_table = "`era5-daily-data`.silver_staging.aer_era5_silver_strict_1950_to_present_staging_interpolation_res4"
    country_index_table = "`era5-daily-data`.silver_staging.esri_worldcountryboundaries_global_silver_res4"
    checkpoint = "/Volumes/era5-daily-data/silver_staging/checkpoints/era5_silver_country_strict_staging_res4"
